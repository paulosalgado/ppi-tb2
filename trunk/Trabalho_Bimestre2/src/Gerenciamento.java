...
public class Gerenciamento {
	 ...
	 *            - o endereço do arquivo que contém a lista de clientes.
	 * @param arquivoOrdens
	 *            - o endereço do arquivo que contém a lista de ordens de
	 *            serviço.
	 */
	public Gerenciamento(String arquivoClientes, String arquivoOrdens) {
		this.listaClientes = TratamentoDeArquivos.lerDadosCliente(arquivoClientes);
		this.listaOrdensDeServico = TratamentoDeArquivos.lerDadosOrdemDeServico(arquivoOrdens);
	}
	 ...
	 * 
	 * @param arquivoClientes
	 *            - o endereço do arquivo que quer se salvar os clientes.
	 * @param arquivoOrdens
	...
	public void salvarArquivos(String arquivoClientes, String arquivoOrdens) {
		TratamentoDeArquivos.salvarArquivoCliente(arquivoClientes, getListaClientes());
		TratamentoDeArquivos.salvarArquivoOrdemDeServico(arquivoOrdens, getListaOrdensDeServico());
	}
	 ...
	 * 
	 * @param nome
	 *            - o nome do novo cliente.
	 * @param endereco
	 *            - o endereço do novo cliente.
	 * @param contato
	 *            - o contato do novo cliente.
	 * 
	 * @return <code>true</code> caso o cliente seja cadastrado,
	 *         <code>false</code> caso contrário.
	 */
	public boolean cadastrarCliente(String nome, String endereco, String contato) {
		if (!this.listaClientes.vazia()) {
			if (pesquisar(nome).getNome().equalsIgnoreCase(nome)) {
				return false;
			}
		}
	 ...
	 *            - o nome do cliente que se deseja pesquisar.
	 * 
	 * @return o cliente encontrado, <code>null</code> caso contrário.
	 */
	 ...
	 * 
	 * @param antigo
	 *            - o cliente a ser modificado
	 * @param novoNome
	 *            - o novo nome do cliente.
	 * @param novoEndereco
	 *            - o novo endereço do cliente.
	 * @param novoContato
	 *            - o novo contato do cliente.
	 * 
	 ...
	 * 
	 * @param descricao
	 *            - a descrição da ordem.
	 * @param dataAbertura
	 *            - a data de criação da ordem.
	 * @param listaClientesEnvolvidos
	 *            - a lista com os clientes envolvidos da ordem.
	 * @param prioridade
	...
	public void registrarOrdemDeServico(String descricao, Date dataAbertura, ListaEncadeadaDinamica<Integer> listaClientesEnvolvidos, 
			String prioridade) {
		OrdemDeServico provisorio = new OrdemDeServico(this.listaOrdensDeServico.tamanho()+1, descricao, dataAbertura, listaClientesEnvolvidos, 
				prioridade);
	 ...
	 * 
	 * @param codigoOrdemDeServico
	 *            - o código da ordem de serviço que se deseja encerrar.
	 * @param descricaoAtendimento
	 *            - a descrição do atendimento realizado.
	 * @param dataEncerramento
	 *            - a data de encerramento da ordem.
	 * 
	...
	public boolean encerrarOrdemDeServico(int codigoOrdemDeServico, String descricaoAtendimento, Date dataEncerramento) {
		...
		if (provisorio.getDataEnceramento() == null) {
	...
	/**
	 * Busca em uma lista as ordens de serviço pertencentes a um determinado
	 * cliente.
	 * 
	 * @param cliente
	 *            - o cliente na qual se deseja buscar as ordens.
	 * 
	 * @return uma lista com as ordens de serviço do cliente, <code>null</code>
	 ...
	 * 
	 * @return uma lista com as ordens de serviço finalizadas, <code>null</code>
	 *         caso a lista esteja vazia.
	 */
